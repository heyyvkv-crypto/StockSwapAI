...
export default function Simulator() {
  const [newPrice, setNewPrice] = useState("8299");
  ...
  const handleSimulate = () => {
    ...
    setTimeout(() => {
      setResults({
        marginPercentage: 25,
        marginValue: 954500, // ₹11,500 * 83
        marginChange: 5,
        storageCost: 41500, // ₹500 * 83
        storageChange: -8300, // -₹100 * 83
        cashFlow: 99600, // ₹1,200 * 83
        cashFlowChange: 20,
      });
          ...
          <Card className="p-6 bg-gradient-card border-border/50">
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground mt-1">Current price: ₹8,299</p>
              </div>
            ...
            <Card className="p-6 bg-gradient-card border-border/50">
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center justify-between p-3 rounded-lg bg-muted/30">
                  ...
                  <span className="text-sm font-medium">₹8,299</span>
                </div>
                <div className="flex items-center justify-between p-3 rounded-lg bg-muted/30">
              ...
              <Card className="p-6 bg-gradient-card border-border/50">
                ...
                <div className="space-y-4">
                  ...
                  <div className="p-4 rounded-lg bg-muted/30">
                    ...
                    <div className="text-2xl font-bold text-foreground">
                      ₹{(results.storageCost * 83).toLocaleString()}
                    </div>
                  </div>
                  ...
                  <div className="p-4 rounded-lg bg-muted/30">
                    ...
                    <div className="text-2xl font-bold text-foreground">
                      ₹{(results.cashFlow * 83).toLocaleString()}
                    </div>
                  </div>
                </div>
            ...
            <div className="space-y-3">
              ...
              <div className="space-y-2">
                <div className="flex justify-between p-3 rounded-lg bg-muted/20">
                  ...
                  <span className="text-sm font-medium">₹9,54,500</span>
                </div>
                <div className="flex justify-between p-3 rounded-lg bg-muted/20">
                ...
                <div className="flex justify-between p-3 rounded-lg bg-muted/20">
                  ...
                  <span className="text-sm font-medium">₹49,800</span>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-3">
              ...
              <div className="space-y-2">
                <div className="flex justify-between p-3 rounded-lg bg-success/10 border border-success/20">
                  <span className="text-sm">Revenue</span>
                  <span className="text-sm font-medium text-success">₹11,45,400 (+20%)</span>
                </div>
                <div className="flex justify-between p-3 rounded-lg bg-success/10 border border-success/20">
                  <span className="text-sm">Margin</span>
                ...
                <div className="flex justify-between p-3 rounded-lg bg-success/10 border border-success/20">
                  <span className="text-sm">Storage Cost</span>
                  <span className="text-sm font-medium text-success">₹41,500 (-16.7%)</span>
                </div>
              </div>
            </div>
          </div>
