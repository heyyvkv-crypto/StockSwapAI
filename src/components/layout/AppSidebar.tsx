...
const external = [
  { title: "StockSwap", href: "/stockswap.html", icon: BarChart3 },
];
      ...
      <SidebarContent className="bg-sidebar">
        <div className="p-4 border-b border-border/50">
          <div className="flex items-center gap-3">
            ...
            {open && (
              <div>
                <h2 className="font-bold text-lg">StockFlow AI</h2>
                ...
                <SidebarMenuItem key={item.href}>
                  <SidebarMenuButton asChild>
                    <a
                      ...
                      className={`flex items-center gap-3 px-3 py-2 rounded-lg transition-all hover:bg-muted/50 text-muted-foreground hover:text-foreground`}
                    >
                      <item.icon className="w-5 h-5" />
                      {open && <span>{item.title}</span>}
                    </a>
